...
{
  LED_set ( 0, 7, 40,brightness);
  LED_set ( 0, 6, 40,brightness);
  LED_set ( 0, 5, 40,brightness);
  LED_set ( 0, 4, 40,brightness);
  LED_set ( 0, 3, 40,brightness);
  LED_set ( 1, 7, 40,brightness);
  LED_set ( 1, 5, 40,brightness);
  LED_set ( 1, 3, 40,brightness);
  LED_set ( 3, 7, 40,brightness);
  LED_set ( 3, 6, 40,brightness);
  LED_set ( 3, 5, 40,brightness);
  LED_set ( 3, 4, 40,brightness);
  LED_set ( 3, 3, 40,brightness);
  LED_set ( 4, 6, 40,brightness);
  LED_set ( 4, 5, 40,brightness);
  LED_set ( 5, 5, 40,brightness);
  LED_set ( 5, 4, 40,brightness);
  LED_set ( 6, 7, 40,brightness);
  LED_set ( 6, 6, 40,brightness);
  LED_set ( 6, 5, 40,brightness);
  LED_set ( 6, 4, 40,brightness);
  LED_set ( 6, 3, 40,brightness);
  LED_set ( 8, 7, 40,brightness);
  LED_set ( 8, 6, 40,brightness);
  LED_set ( 8, 5, 40,brightness);
  LED_set ( 8, 4, 40,brightness);
  LED_set ( 8, 3, 40,brightness);
  LED_set ( 9, 7, 40,brightness);
  LED_set ( 9, 3, 40,brightness);
  LED_set ( 10, 6,40,brightness);
  LED_set ( 10, 5,40,brightness);
  LED_set ( 10, 4,40,brightness);
  delay(200);
}
